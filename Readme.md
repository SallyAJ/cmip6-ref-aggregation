...
Before running either script, update the placeholder paths in `avg_obs.R` and `avg_proj.R` to point to the corresponding
output directories generated by the Python workflow, as indicated in more detail in each respective script. 
